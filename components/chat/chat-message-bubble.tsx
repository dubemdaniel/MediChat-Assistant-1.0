...
export default function ChatMessageBubble({ message, onSuggestedQuestionClick }: ChatMessageBubbleProps) {
                    ...
                    {possibleConditions.map((condition, index) => (
                      <li key={condition} className="p-3 border rounded-md bg-secondary/50">
                        <div className="flex justify-between items-center">
                          ...
                          {confidenceLevels && confidenceLevels[index] !== undefined && (
  ...
  return (
    <div className={cn('flex animate-in fade-in slide-in-from-bottom-4 duration-300 my-2', isUser ? 'justify-end' : 'justify-start')}>
      <div
        className={cn(
